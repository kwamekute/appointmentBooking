...
<div class="sidebar-container">
	<div class="sidemenu-container navbar-collapse collapse fixed-menu">
		<div id="remove-scroll" class="left-sidemenu">
			...
			<!-- Staff Menu Group -->
			<li class="nav-item <?php echo $page == 'staff'?'active open':''; ?>">
				...
				<ul class="sub-menu">
					...
					<li class="nav-item <?php echo $page == 'addstaff'?'active open':''; ?>">
			...
			<!-- Customer Menu Group -->
			<li class="nav-item <?php echo $page == 'cust'?'active ':''; ?>">
				...
				<ul class="sub-menu">
					...
					<li class="nav-item <?php echo $page == "addcust'?'active open':'$page == 'cust'"; ?>">
			...
			<!-- Company Menu Group -->
			<li class="nav-item <?php echo $page == 'comp' ?'active open':''; ?>">
				<a href="#" class="nav-link nav-toggle"> <i class="material-icons">group</i>
				...
				<ul class="sub-menu">
					...
					<li class="nav-item <?php echo $page == 'addcomp'?'active ':''; ?>">
