			...
			<div class="card-body ">
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-6">
						<div class="btn-group">
							<a href="addjob.php" id="addRow" class="btn btn-info">
							...
							<div class="table-scrollable">
								<table class="table table-hover table-checkable order-column full-width" id="capptb" name="capptb">
									<thead>
										<tr>
											<th>Queue</th>
											<th>Customer</th>
											<th>Vehicle</th>						
											<th>Customer Service Description</th>
											<th>Service Advice</th>
											<th>Action </th>
										</tr>
									</thead>
									<tbody>
